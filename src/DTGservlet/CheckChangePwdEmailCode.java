...
@WebServlet("/html/CheckChangePwdEmailCode")
public class CheckChangePwdEmailCode extends HttpServlet{
    private static final long serialVersionUID = 1L;
    public CheckChangePwdEmailCode() {
        super();
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            String emailCode=session.getAttribute("ChangePwdCode").toString();
            String emailID=session.getAttribute("ChangePwdID").toString();
